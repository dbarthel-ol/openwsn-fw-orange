...
void sixtop_init() {
   ...
   observer_entity_add(COMPONENT_SIXTOP, COMPONENT_NAME_SIXTOP, 3);
   observer_property_declaration_float(PROPERTY_ENTITY_LEVEL, PROPERTY_NAME_ENTITY_LEVEL, PREFIX_NONE, UNIT_NONE, ENTITY_CROSS_NET_LINK_LEVEL);
   observer_property_declaration_uint16(PROPERTY_L25_MAINTENANCE_PERIOD, PROPERTY_NAME_L25_MAINTENANCE_PERIOD, PREFIX_MILLI, UNIT_SECOND, sixtop_vars.periodMaintenance);
   observer_property_declaration_uint16(PROPERTY_L25_KA_PERIOD, PROPERTY_NAME_L25_KA_PERIOD, PREFIX_MILLI, UNIT_SECOND, sixtop_vars.kaPeriod * PORT_TsSlotDuration / PORT_TICS_PER_MS);
}
...
void task_sixtopNotifSendDone() {
   ...
   switch (msg->creator) {
      ...
      case COMPONENT_SIXTOP:
         ...
         observer_entity_property_update(COMPONENT_SIXTOP, 1);
         observer_property_update_uint16(PROPERTY_L25_MAINTENANCE_PERIOD, sixtop_vars.periodMaintenance);
         break;
