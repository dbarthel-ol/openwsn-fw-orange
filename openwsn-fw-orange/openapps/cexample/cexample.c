...
void cexample_task_cb() {
   ...
   //observer report
   owsn_observer_frame_produce(pkt, 2);
   observer_property_declaration_uint16(PROPERTY_L4_DESTINATION_PORT, PROPERTY_NAME_L4_DESTINATION_PORT, PREFIX_NONE, UNIT_NONE, WKP_UDP_COAP);
   observer_property_declaration_byte_array(PROPERTY_L3_FRAME_DESTINATION_ADDRESS, PROPERTY_NAME_L3_FRAME_DESTINATION_ADDRESS, 16,&pkt->l3_destinationAdd.addr_128b);
